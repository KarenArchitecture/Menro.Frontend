...
export default function CombosSection() {
    ...
    const candidateFoods = useMemo(
        () =>
        foods.filter(
            (f) => f.id !== selectedFoodId && !comboIds.includes(f.id),
        ),
    ...
    const persistCombos = async (nextIds) => {
        ...
        setComboIds(prevIds); // roll back on failure
            ...
            <div className="combos-mgmt__editor">
                ...
                <>
                    ...
                    <div className="empty-hint">
                        هنوز ترکیبی برای این غذا اضافه نشده است. روی «افزودن
                        ترکیب» بزنید تا شروع کنید.
                    </div>
                    ) : (
