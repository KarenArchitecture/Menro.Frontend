...
//after internet connection Sina Version
// import React, { useEffect, useMemo, useRef } from "react";
// import { useInfiniteQuery } from "@tanstack/react-query";
// import {
//   getPopularFoodByRandomCategory,
...
//   searchQuery = "",
//   showAds = true,
//   // NEW: report search result count to parent (HomePage) so it can build "نتایج جستجو (N)"
//   onSearchCount,
// }) {
//   const loadMoreRef = useRef(null);
...
//   // - in search mode, send matched count (once data is ready)
//   // - out of search mode, send null (unknown / not applicable)
//   useEffect(() => {
...
//     // don't push misleading 0 while loading/error
//     if (isLoading || isError) return;

//     onSearchCount(matchedFoods.length);
//   }, [onSearchCount, isSearchMode, isLoading, isError, matchedFoods.length]);
...
//   // Intersection observer for infinite load (works in both modes)
//   useEffect(() => {
//     if (!loadMoreRef.current || !hasNextPage) return;
...
//   // ───────────── SEARCH MODE: unified list ─────────────
//   // Latest tweak: if there are NO matched foods, hide this whole section (no empty box),
//   // because HomePage will decide whether to show a global "no results" message.
//   if (isSearchMode) {
//     return (
//       <>
...
//   // Report count to parent (HomePage)
//   useEffect(() => {
//     if (!onSearchCount) return;
...
//   // SEARCH MODE: unified list (no ads)
//   if (isSearchMode) {
//     return (
//       <>
//         {matchedFoods.length > 0 ? (
//           <PopularFoodRow data={{ categoryTitle: "", foods: matchedFoods }} hideTitle isSearchMode />
//         ) : null}
...
//           <AdBanner
//             key={block.key}
//             slotKey={block.key}  // ✅ IMPORTANT (without this AdBanner won't fetch)
//             height={260}
//             overlay={0.5}
//             objectPosition="center"
//           />
