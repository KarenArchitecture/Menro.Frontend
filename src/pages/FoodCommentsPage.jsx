...
export default function FoodCommentsPage() {
    ...
    const submitComment = useMutation({
        ...
        onError: (err) => {
        const message = err.response?.data || "ثبت نظر با خطا مواجه شد. دوباره تلاش کنید.";
    ...
    const handleComposerSubmit = ({ text, rating }, resetForm) => {
        ...
        onAuthenticated: () => {
            ...
            { text, rating },
            {
                ...
                showToast({ type: "success", message: "نظر شما با موفقیت ثبت شد." });
                resetForm();
                },
            },
            );
    ...
    return (
        ...
        <div className="comments-list">
            ...
            <div className="comment-hint-box">
                <img src="/images/comments/comment-icon.svg" alt="" className="comment-hint-box__icon" />
                <p>هنوز نظری برای این غذا ثبت نشده. اولین نفری باش که نظرش رو می‌نویسه!</p>
            </div>
            )}
            {comments.map((c) => (
            <CommentCard
        ...
        {foodId && food?.hasUserCommented && (
            <div className="comment-hint-box">
            <img src="/images/comments/star-active-icon.svg" alt="" className="comment-hint-box__icon" />
